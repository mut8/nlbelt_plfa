...
install.packages("lme4",dep=FALSE)
...
install.packages("Rcpp",repos="http://lme4.r-forge.r-project.org/repos")
str(Dyestuff)
...
lmer(d13C ~ 1 + (1|plfa), plfas_reorg)
...
anova(lm(plfas_reorg$d13C[c] ~ plfas_reorg$Horizon[c] * plfas_reorg$plfa[c]))
anova(lm(plfas_reorg$d13C[c] ~ plfas_reorg$Horizon[c] * plfas_reorg$plfa[c]+plfas_reorg$Region[c]))
anova(lm(plfas_reorg$d13C[c] ~ plfas_reorg$Horizon[c] * plfas_reorg$plfa[c]+plfas_reorg$Region[c]*plfas_reorg$Horizon[c]+plfas_reorg$Region[c]*plfas_reorg$plfa[c]))
anova(lm(plfas_reorg$d13C[c] ~ plfas_reorg$Horizon[c] * plfas_reorg$plfa[c]*plfas_reorg$Region[c]))

summary(lm(plfas_reorg$d13C[c] ~ plfas_reorg$Horizon[c] * plfas_reorg$plfa[c]+plfas_reorg$Region[c]))
summary(lm(plfas_reorg$d13C[c] ~ plfas_reorg$Horizon[c] * plfas_reorg$plfa[c]+plfas_reorg$Region[c]*plfas_reorg$Horizon[c]))
summary(lm(plfas_reorg$d13C[c] ~ plfas_reorg$Horizon[c] * plfas_reorg$plfa[c]+plfas_reorg$Region[c]*plfas_reorg$plfa[c]))
summary(lm(plfas_reorg$d13C[c] ~ plfas_reorg$Horizon[c] * plfas_reorg$plfa[c]+plfas_reorg$Region[c]*plfas_reorg$Horizon[c]+plfas_reorg$Region[c]*plfas_reorg$plfa[c]))
summary(lm(plfas_reorg$d13C[c] ~ plfas_reorg$Horizon[c] * plfas_reorg$plfa[c]*plfas_reorg$Region[c]))

l1<-lm(plfas_reorg$d13C[c] ~ plfas_reorg$Horizon[c] * plfas_reorg$plfa[c])
l2<-lm(plfas_reorg$d13C[c] ~ plfas_reorg$Horizon[c] * plfas_reorg$plfa[c]+plfas_reorg$Region[c])
l3<-lm(plfas_reorg$d13C[c] ~ plfas_reorg$Horizon[c] * plfas_reorg$plfa[c]+plfas_reorg$Region[c]*plfas_reorg$Horizon[c])
l4<-lm(plfas_reorg$d13C[c] ~ plfas_reorg$Horizon[c] * plfas_reorg$plfa[c]+plfas_reorg$Region[c]*plfas_reorg$plfa[c])
...
plot(lm1$residuals~plfas_reorg$Region[c], xlim=c(0.5,2.5))
...
ord.plot(ord,site.sep2=samples$Horizon[cond2], site.sep1=samples$Site[cond2], pch=21:24, pt.bg=c(colscale2), spe.label.type="text", spe.labels=fames$FAME, cex.leg=.5, spe.mult=1.5, site.cex=1)
